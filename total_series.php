...
$totalRecordsQuery = "SELECT COUNT(*) as total FROM series";
...
$query = "SELECT * FROM series ORDER BY id DESC LIMIT $offset, $recordsPerPage";
...
<head>
    ...
    <title>Total Series - Admin Dashboard</title>
    ...
    <div class="main-content">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
            ...
            <a href="admin_dashboard.php" class="upload-button">Home</a>
                <a href="upload_series.php" class="upload-button">
                    <i class="fas fa-plus"></i> Upload New Series
                </a>
            </div>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <img src="<?php echo $row['poster']; ?>" alt="Series Poster" class="series-thumbnail">
                    </td>
                    ...
                    <td><?php echo htmlspecialchars($row['episodes']); ?></td>
                    
                    <td>
                        <a href="edit_series.php?id=<?php echo $row['id']; ?>" title="Edit">
                            <i class="fas fa-edit"></i>
                        </a>
                        <a href="delete_series.php?id=<?php echo $row['id']; ?>" title="Delete" 
